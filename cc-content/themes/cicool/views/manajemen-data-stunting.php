...
<main>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="section__title-wrapper-2 text-center mb-60">
						<h3 class="section__title-2"><?= $mantastu->aksi_koko_judul;?></h3>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="certificate__area pb-120 pt-30">
		...
		<?php
			if (!empty($mantastu->aksi_koko_media) || $mantastu->aksi_koko_media != Null) {
		?>
				<div class="row">
					<div class="col-md-12">
						<div class="certificate__content">
							...
							<?php
								$expl_media = explode(',', $mantastu->aksi_koko_media);
