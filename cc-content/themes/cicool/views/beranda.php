...
<head>
	...
	<style type="text/css">
		...
		.carousel-caption h2, .carousel-caption .carousel-caption-description {
			color: white;
		}
							...
							<div class="header__category d-flex align-items-center justify-content-end">
								<div class="header__category-icon mr-10">
									<svg width="15" height="15" viewBox="0 0 15 15" fill="none"
										xmlns="http://www.w3.org/2000/svg">
										<path class="header-dot-menu-opacity" opacity="0.7"
											d="M7.5217 2.9096C8.32516 2.9096 8.9765 2.25826 8.9765 1.4548C8.9765 0.651336 8.32516 0 7.5217 0C6.71823 0 6.06689 0.651336 6.06689 1.4548C6.06689 2.25826 6.71823 2.9096 7.5217 2.9096Z"
											fill="white" />
										<path
											d="M13.5193 2.9096C14.3227 2.9096 14.9741 2.25826 14.9741 1.4548C14.9741 0.651336 14.3227 0 13.5193 0C12.7158 0 12.0645 0.651336 12.0645 1.4548C12.0645 2.25826 12.7158 2.9096 13.5193 2.9096Z"
											fill="white" />
										<path
											d="M1.4548 2.9096C2.25826 2.9096 2.9096 2.25826 2.9096 1.4548C2.9096 0.651336 2.25826 0 1.4548 0C0.651336 0 0 0.651336 0 1.4548C0 2.25826 0.651336 2.9096 1.4548 2.9096Z"
											fill="white" />
										<path
											d="M7.5217 9.00193C8.32516 9.00193 8.9765 8.35059 8.9765 7.54713C8.9765 6.74367 8.32516 6.09233 7.5217 6.09233C6.71823 6.09233 6.06689 6.74367 6.06689 7.54713C6.06689 8.35059 6.71823 9.00193 7.5217 9.00193Z"
											fill="white" />
										<path class="header-dot-menu-opacity" opacity="0.7"
											d="M13.5193 9.00193C14.3227 9.00193 14.9741 8.35059 14.9741 7.54713C14.9741 6.74367 14.3227 6.09233 13.5193 6.09233C12.7158 6.09233 12.0645 6.74367 12.0645 7.54713C12.0645 8.35059 12.7158 9.00193 13.5193 9.00193Z"
											fill="white" />
										<path class="header-dot-menu-opacity" opacity="0.7"
											d="M7.5217 15C8.32516 15 8.9765 14.3487 8.9765 13.5452C8.9765 12.7417 8.32516 12.0904 7.5217 12.0904C6.71823 12.0904 6.06689 12.7417 6.06689 13.5452C6.06689 14.3487 6.71823 15 7.5217 15Z"
											fill="white" />
										<path
											d="M13.5193 15C14.3227 15 14.9741 14.3487 14.9741 13.5452C14.9741 12.7417 14.3227 12.0904 13.5193 12.0904C12.7158 12.0904 12.0645 12.7417 12.0645 13.5452C12.0645 14.3487 12.7158 15 13.5193 15Z"
											fill="white" />
										<path class="header-dot-menu-opacity" opacity="0.7"
											d="M1.4548 9.00193C2.25826 9.00193 2.9096 8.35059 2.9096 7.54713C2.9096 6.74367 2.25826 6.09233 1.4548 6.09233C0.651336 6.09233 0 6.74367 0 7.54713C0 8.35059 0.651336 9.00193 1.4548 9.00193Z"
											fill="white" />
										<path
											d="M1.4548 15C2.25826 15 2.9096 14.3487 2.9096 13.5452C2.9096 12.7417 2.25826 12.0904 1.4548 12.0904C0.651336 12.0904 0 12.7417 0 13.5452C0 14.3487 0.651336 15 1.4548 15Z"
											fill="white" />
									</svg>
								</div>
			...
			<div class="slider__active swiper-container">
				<div class="swiper-wrapper">
					<div class="slider__item swiper-slide p-relative slider__height slider__height-3 d-flex align-items-center z-index-1">
						<div class="slider__bg slider__overlay slider__overlay-3 include-bg" data-background="assets_stunting/stunting/contoh-1.png"></div>
						<div class="carousel-caption">
                            <h2>Carousel Fullscreen Template #01</h2>
                            <div class="carousel-caption-description">
                                <p>#01 This is a free Fullscreen Carousel template made with the Bootstrap 4 framework.</p>
                            </div>
                        </div>
					</div>
					<div class="slider__item swiper-slide p-relative slider__height slider__height-3 d-flex align-items-center z-index-1">
						<div class="slider__bg slider__overlay slider__overlay-3 include-bg" data-background="assets_stunting/stunting/contoh-2.png"></div>
						<div class="carousel-caption">
                            <h2>#02 Carousel Fullscreen Template</h2>
                            <div class="carousel-caption-description">
                                <p>#02 This is a free Fullscreen Carousel template made with the Bootstrap 4 framework.</p>
                            </div>
                        </div>
					</div>
					<div class="slider__item swiper-slide p-relative slider__height slider__height-3 d-flex align-items-center z-index-1">
						<div class="slider__bg slider__overlay slider__overlay-3 include-bg" data-background="assets_stunting/stunting/contoh-3.png"></div>
						<div class="carousel-caption">
                            <h2>#03 Carousel Fullscreen Template</h2>
                            <div class="carousel-caption-description">
                                <p>#03 This is a free Fullscreen Carousel template made with the Bootstrap 4 framework.</p>
                            </div>
                        </div>
					</div>
					<div class="slider__item swiper-slide p-relative slider__height slider__height-3 d-flex align-items-center z-index-1">
						<div class="slider__bg slider__overlay slider__overlay-3 include-bg" data-background="assets_stunting/stunting/contoh-4.png"></div>
						<div class="carousel-caption">
                            <h2>#04 Carousel Fullscreen Template</h2>
                            <div class="carousel-caption-description">
                                <p>#04 This is a free Fullscreen Carousel template made with the Bootstrap 4 framework.</p>
                            </div>
                        </div>
					</div>
					<div class="slider__item swiper-slide p-relative slider__height slider__height-3 d-flex align-items-center z-index-1">
						<div class="slider__bg slider__overlay slider__overlay-3 include-bg" data-background="assets_stunting/stunting/contoh-5.png"></div>
						<div class="carousel-caption">
                            <h2>#05Carousel Fullscreen Template</h2>
                            <div class="carousel-caption-description">
                                <p>#05 This is a free Fullscreen Carousel template made with the Bootstrap 4 framework.</p>
                            </div>
                        </div>
					</div>
				</div>
				...
				<div class="row">
						...
						<div class="category__item-3 fix transition-3 white-bg mb-30">
							...
							<div class="category__list">
								<ul>
									...
									<li><a href="course-v1.html">Web Development <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">Machine Learning <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">App Development <i
												class="fa-regular fa-arrow-right"></i></a></li>
								</ul>
							</div>
					...
					<div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
						<div class="category__item-3 fix transition-3 white-bg mb-30">
							...
							<div class="category__list">
								<ul>
									<li><a href="course-v1.html">Cyber Security <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">Visual Studio Code <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">AWS Certification <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">Ethical Hacking <i
												class="fa-regular fa-arrow-right"></i></a></li>
								</ul>
							</div>
							<div class="category__btn-3">
					...
					<div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
						<div class="category__item-3 fix transition-3 white-bg mb-30">
							...
							<div class="category__list">
								<ul>
									<li><a href="course-v1.html">Advertising <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">UX Design <i class="fa-regular fa-arrow-right"></i></a>
									</li>
									<li><a href="course-v1.html">History of Art <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">Color & Form <i
												class="fa-regular fa-arrow-right"></i></a></li>
								</ul>
							</div>
							<div class="category__btn-3">
					...
					<div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
						<div class="category__item-3 fix transition-3 white-bg mb-30">
							...
							<div class="category__list">
								<ul>
									<li><a href="course-v1.html">Accounting <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">Financial Analysis <i
												class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">SQL <i class="fa-regular fa-arrow-right"></i></a></li>
									<li><a href="course-v1.html">Business statistics <i
												class="fa-regular fa-arrow-right"></i></a></li>
								</ul>
							</div>
							<div class="category__btn-3">
				...
				<div class="counter__inner counter__inner-2 grey-bg-8">
					<div class="row">
						<div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
							<div
								class="counter__item d-flex align-items-start counter__item-border counter__item-border-2">
								<div class="counter__icon counter__icon-2 mr-15">
									<svg width="38" height="39" viewBox="0 0 38 39" fill="none"
										...
										<path d="M11.8 2.9668H13.6C10.09 13.4788 10.09 24.8548 13.6 35.3668H11.8"
											stroke="#031220" stroke-width="1.5" stroke-linecap="round"
											stroke-linejoin="round" />
										<path d="M24.4 2.9668C26.146 8.2228 27.028 13.6948 27.028 19.1668"
											stroke="#031220" stroke-width="1.5" stroke-linecap="round"
											stroke-linejoin="round" />
								...
								<span>
									<svg width="26" height="28" viewBox="0 0 26 28" fill="none"
										...
										<path d="M1.58765 13.9002L20.4876 13.0752" stroke="#031220" stroke-width="1.5"
											stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
										<path d="M2.75 26.5H19" stroke="#007A70" stroke-width="1.5"
											stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
										<path class="fill-white"
											...
											fill="#007A70" stroke="#007A70" stroke-linecap="round"
											stroke-linejoin="round" />
									</svg>
								</span>
							</div>
												...
												<a href="#">
													<span>
														<svg width="10" height="12" viewBox="0 0 10 12" fill="none"
															xmlns="http://www.w3.org/2000/svg">
															<path
																d="M1 1.91583C1 1.52025 1.43762 1.28133 1.77038 1.49524L8.12353 5.57941C8.42969 5.77623 8.42969 6.22377 8.12353 6.42059L1.77038 10.5048C1.43762 10.7187 1 10.4798 1 10.0842V1.91583Z"
																fill="#007A70" stroke="#007A70" stroke-width="1.5"
																stroke-linecap="round" stroke-linejoin="round" />
														</svg>
													</span>
													56 videos
												...
												<a href="#">
													<span>
														<svg width="12" height="12" viewBox="0 0 12 12" fill="none"
															xmlns="http://www.w3.org/2000/svg">
															<path
																d="M7.03658 0.866411L8.09247 2.99539C8.23645 3.29176 8.62041 3.57603 8.94437 3.63046L10.8582 3.95102C12.082 4.15666 12.37 5.0518 11.4881 5.93484L10.0003 7.43481C9.74828 7.68883 9.6103 8.17874 9.68829 8.52954L10.1142 10.3864C10.4502 11.8561 9.67629 12.4246 8.38643 11.6565L6.59263 10.5859C6.26867 10.3924 5.73473 10.3924 5.40476 10.5859L3.61096 11.6565C2.3271 12.4246 1.54719 11.85 1.88315 10.3864L2.3091 8.52954C2.3871 8.17874 2.24911 7.68883 1.99714 7.43481L0.509303 5.93484C-0.3666 5.0518 -0.084631 4.15666 1.13923 3.95102L3.05302 3.63046C3.37099 3.57603 3.75494 3.29176 3.89893 2.99539L4.95481 0.866411C5.53075 -0.288804 6.46664 -0.288804 7.03658 0.866411Z"
																fill="#FFAE10" />
														</svg>
													</span>
													2.8k Reviews
								...
								<span>
									<svg width="20" height="26" viewBox="0 0 20 26" fill="none"
										...
										<path class="fill-white"
											...
											fill="#007A70" stroke="#007A70" stroke-miterlimit="10"
											stroke-linecap="round" stroke-linejoin="round" />
										<path
				...
				<div class="row justify-content-center">
					<div class="col-xxl-8 col-xl-8 col-lg-8">
						<div class="course__enroll-wrapper mt-40 p-relative d-sm-flex align-items-center justify-content-between include-bg"
							data-background="assets_stunting/img/course/bg/course-bg.png">
						...
						<div class="col-xxl-7">
							<div class="certificate__content">
								...
								<div class="certificate__links d-sm-flex align-items-center">
									<a href="https://www.youtube.com/watch?v=4XGLPTtn4xQ"
							...
							<div class="price__content">
								<div class="price__list mb-35">
									<ul>
										...
										<li class="unavailable">Optimuze hashtags <span><i
													class="fa-solid fa-xmark"></i></span></li>
										<li class="unavailable">Unlimited user <span><i
													class="fa-solid fa-xmark"></i></span></li>
									</ul>
								</div>
								...
								<div class="footer__contact">
									<ul>
										<li>
											...
											<h4><a href="https://www.google.com/maps/place/%E0%A6%A2%E0%A6%BE%E0%A6%95%E0%A6%BE/@23.7807777,90.3492857,12z/data=!3m1!4b1!4m5!3m4!1s0x3755b8b087026b81:0x8fa563bbdd5904c2!8m2!3d23.810332!4d90.4125181"
