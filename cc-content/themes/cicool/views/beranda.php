			...
			<div class="row">
								...
								<ul>
									...
									<li>
										<div class="course__tutor-3">
											<a href="#">
												<img src="<?= base_url(); ?>assets_stunting/img/course/tutor/course-tutor-1.jpg"
													alt="">
											</a>
										</div>
									</li>
				...
				<div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
					<div class="course__item-3 white-bg transition-3 mb-30">
						...
						<div class="course__content-3">
							<h3 class="course__title-3">
								<a href="course-details.html">The Challenge Of Global LearningIn Public Education.</a>
							</h3>
							<div class="course__meta d-flex align-items-center justify-content-between">
								<div class="course__tag-3">
									<a href="#">Mechanical</a>
							...
							<div class="course__sort-info">
								<ul>
									...
									<li>
										<div class="course__tutor-3">
											<a href="#">
												<img src="<?= base_url(); ?>assets_stunting/img/course/tutor/course-tutor-2.jpg"
													alt="">
											</a>
										</div>
									</li>
				...
				<div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
					<div class="course__item-3 white-bg transition-3 mb-30">
						...
						<div class="course__content-3">
							<h3 class="course__title-3">
								<a href="course-details.html">Become a UI/UX Designer Everything You need To Know.</a>
							</h3>
							<div class="course__meta d-flex align-items-center justify-content-between">
								<div class="course__tag-3">
									<a href="#">Marketing</a>
							...
							<div class="course__sort-info">
								<ul>
									...
									<li>
										<div class="course__tutor-3">
											<a href="#">
												<img src="<?= base_url(); ?>assets_stunting/img/course/tutor/course-tutor-3.jpg"
													alt="">
											</a>
										</div>
									</li>
			...
			<div class="row justify-content-center">
				<div class="col-xxl-8 col-xl-8 col-lg-8">
					<div class="course__enroll-wrapper mt-40 p-relative d-sm-flex align-items-center justify-content-between include-bg"
						data-background="<?= base_url(); ?>assets_stunting/img/course/bg/course-bg.png">
