...
<body>
	...
	<header id="beranda">
		<div class="header__area">
			<div class="header__bottom header__bottom-3">
				<div class="container">
					<div class="row align-items-center">
						<!-- <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-6 d-none d-lg-block"></div> -->
						<div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-6">
							<div class="logo text-lg-center">
								<a href="<?= base_url();?>">
									...
									<img src="<?= base_url().'uploads/about/' . $about->about_logo;?>" alt="logo" style="width: 300px;">
								</a>
							</div>
						</div>
			...
			<div class="header__menu theme-bg-red d-none d-lg-block">
				<div class="container">
					<div class="row align-items-center">
