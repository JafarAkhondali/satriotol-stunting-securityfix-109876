			...
			<div class="row">
				<div class="col-xxl-12">
					<div class="section__title-wrapper-2 text-center mb-60">
						<h3 class="section__title-2">Aksi Konvergensi</h3>
						<p style="font-size: 16pt; line-height: 1.5;">Untuk menyelaraskan perencanaan, penganggaran, pelaksanaan, pemantauan, dan pengendalian
							kegiatan lintas sektor serta antar tingkatan pemerintahan dan masyarakat</p>
					</div>
				</div>
			</div>
			<div class="row">
