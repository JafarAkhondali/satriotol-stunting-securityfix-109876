<?= get_header(); ?>
	...
	<!-- Start Career 
	============================================= -->
	<div class="earna-career default-padding pt-50 pb-120">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="section__title-wrapper-2 text-center mb-60">
						<h3 class="section__title-2">Berita</h3>
					</div>
				</div>
			</div>
			...
			<div class="job-lists">
				...
				?>
							<div class="item">
								<div class="info">
								<a href="<?= base_url() . 'blog/' . $blog->slug; ?>"><h4><?php echo $blog->title;?></h4></a>
