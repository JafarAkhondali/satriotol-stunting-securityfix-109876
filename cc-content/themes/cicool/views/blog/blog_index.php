...
<body>
						...
						<div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
							<div class="header__top-right d-flex justify-content-end align-items-center">
								<div class="header__login">
									<a href="sign-in.html"><svg viewBox="0 0 12 14" fill="none"
											xmlns="http://www.w3.org/2000/svg">
											<path
								...
								<div class="header__search w-100 d-none d-xl-block">
									<form action="#">
										<div class="header__search-input">
											...
											<button class="header__search-btn"><svg width="18" height="18"
	...
	<main>
		...
		<section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay"
			data-background="<?php echo base_url();?>assets_stunting/img/breadcrumb/breadcrumb-bg-1.jpg">
			<div class="container">
				<div class="row">
											...
											<div class="row">
													...
													<div class="course__item-2 transition-3 white-bg mb-30 fix">
														<div class="course__thumb-2 w-img fix">
															<a href="course-details.html">
																<img src="<?php echo base_url();?>assets_stunting/img/course/2/course-1.jpg"
																	alt="">
															</a>
														</div>
														<div class="course__content-2">
															...
															<div
																...
																<div class="course__tutor-2">
																	<a href="#">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-1.jpg"
																			alt="">
																	</a>
																</div>
															</div>
												...
												<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
													<div class="course__item-2 transition-3 white-bg mb-30 fix">
														<div class="course__thumb-2 w-img fix">
															<a href="course-details.html">
																<img src="<?php echo base_url();?>assets_stunting/img/course/2/course-2.jpg"
																	alt="">
															</a>
														</div>
														<div class="course__content-2">
															...
															<h3 class="course__title-2">
																<a href="course-details.html">The Challenge Of Global
																	Learning In Public Education.</a>
															</h3>
															<div
																class="course__bottom-2 d-flex align-items-center justify-content-between">
																<div class="course__action">
																...
																<div class="course__tutor-2">
																	<a href="#">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-2.jpg"
																			alt="">
																	</a>
																</div>
															</div>
												...
												<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
													<div class="course__item-2 transition-3 white-bg mb-30 fix">
														<div class="course__thumb-2 w-img fix">
															<a href="course-details.html">
																<img src="<?php echo base_url();?>assets_stunting/img/course/2/course-3.jpg"
																	alt="">
															</a>
														</div>
														<div class="course__content-2">
															...
															<div
																...
																<div class="course__tutor-2">
																	<a href="#">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-3.jpg"
																			alt="">
																	</a>
																</div>
															</div>
												...
												<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
													<div class="course__item-2 transition-3 white-bg mb-30 fix">
														<div class="course__thumb-2 w-img fix">
															<a href="course-details.html">
																<img src="<?php echo base_url();?>assets_stunting/img/course/2/course-4.jpg"
																	alt="">
															</a>
														</div>
														<div class="course__content-2">
															...
															<div
																...
																<div class="course__tutor-2">
																	<a href="#">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-4.jpg"
																			alt="">
																	</a>
																</div>
															</div>
												...
												<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
													<div class="course__item-2 transition-3 white-bg mb-30 fix">
														<div class="course__thumb-2 w-img fix">
															<a href="course-details.html">
																<img src="<?php echo base_url();?>assets_stunting/img/course/2/course-5.jpg"
																	alt="">
															</a>
														</div>
														<div class="course__content-2">
															...
															<h3 class="course__title-2">
																<a href="course-details.html">Machine Learning A-Z:
															...
															<div
																...
																<div class="course__tutor-2">
																	<a href="#">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-5.jpg"
																			alt="">
																	</a>
																</div>
															</div>
												...
												<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
													<div class="course__item-2 transition-3 white-bg mb-30 fix">
														<div class="course__thumb-2 w-img fix">
															<a href="course-details.html">
																<img src="<?php echo base_url();?>assets_stunting/img/course/2/course-6.jpg"
																	alt="">
															</a>
														</div>
														<div class="course__content-2">
															...
															<h3 class="course__title-2">
																<a href="course-details.html">The most complete Design
																	Thinking Course on the Market..</a>
															</h3>
															<div
																class="course__bottom-2 d-flex align-items-center justify-content-between">
																<div class="course__action">
																...
																<div class="course__tutor-2">
																	<a href="#">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-6.jpg"
																			alt="">
																	</a>
																</div>
															</div>
														...
														<div class="row gx-0">
															<div class="col-xxl-4 col-xl-4 col-lg-4">
																<div class="course__thumb w-img p-relative fix">
																	<a href="course-details.html">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/list/course-1.jpg"
																			alt="">
																	</a>
																</div>
															</div>
																	...
																	<div class="course__content p-relative">
																		...
																		<div class="course__summary">
																			<p>Communia virtutes tutiorem declarat
																				stoicorum sanabat oblivisci nostris
																				tamquam iucunditatem</p>
																		</div>
																		<div
																			class="course__bottom d-sm-flex align-items-center justify-content-between">
																			<div class="course__tutor">
																				<a href="#"><img
																						src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-1.jpg"
																						alt="">Brian Cumin</a>
																			</div>
																			<div class="course__lesson">
																				<a href="#"><svg width="14" height="16"
													...
													<div
														...
														<div class="row gx-0">
															<div class="col-xxl-4 col-xl-4 col-lg-4">
																<div class="course__thumb w-img p-relative fix">
																	<a href="course-details.html">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/list/course-2.jpg"
																			alt="">
																	</a>
																</div>
															</div>
													...
													<div
														...
														<div class="row gx-0">
															<div class="col-xxl-4 col-xl-4 col-lg-4">
																<div class="course__thumb w-img p-relative fix">
																	<a href="course-details.html">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/list/course-3.jpg"
																			alt="">
																	</a>
																</div>
															</div>
															<div class="col-xxl-8 col-xl-8 col-lg-8">
																<div class="course__right p-relative">
																	<div class="course__content p-relative">
																		...
																		<h3 class="course__title">
																			<a href="course-details.html">A framework
																				for keeping up with an ever-evolving
																				profession.</a>
																		</h3>
																		<div class="course__summary">
																			<p>Communia virtutes tutiorem declarat
													...
													<div
														...
														<div class="row gx-0">
															<div class="col-xxl-4 col-xl-4 col-lg-4">
																<div class="course__thumb w-img p-relative fix">
																	<a href="course-details.html">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/list/course-4.jpg"
																			alt="">
																	</a>
																</div>
															</div>
													...
													<div
														...
														<div class="row gx-0">
															<div class="col-xxl-4 col-xl-4 col-lg-4">
																<div class="course__thumb w-img p-relative fix">
																	<a href="course-details.html">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/list/course-5.jpg"
																			alt="">
																	</a>
																</div>
															</div>
													...
													<div
														...
														<div class="row gx-0">
															<div class="col-xxl-4 col-xl-4 col-lg-4">
																<div class="course__thumb w-img p-relative fix">
																	<a href="course-details.html">
																		<img src="<?php echo base_url();?>assets_stunting/img/course/list/course-6.jpg"
																			alt="">
																	</a>
																</div>
															</div>
