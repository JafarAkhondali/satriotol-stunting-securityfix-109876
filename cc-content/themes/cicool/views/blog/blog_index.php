...
<html class="no-js" lang="zxx">
   <head>
      ...
      <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url();?>assets_stunting/img/favicon.png">
   ...
   <body>
      ...
      <div id="loading">
         <div id="loading-center">
            <div id="loading-center-absolute">
               ...
               <img src="<?php echo base_url();?>assets_stunting/img/favicon.png" alt="">
            </div>
         </div>  
      </div>
      <!-- pre loader area end -->
               ...
               <div class="container">
                  <div class="row align-items-center">
                     <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-6 col-6">
                        <div class="logo">
                           <a href="index.html">
                              <img src="<?php echo base_url();?>assets_stunting/img/logo/logo.png" alt="logo">
                           </a>
                        </div>
                     </div>
      ...
      <main>
         ...
         <section class="breadcrumb__area include-bg pt-150 pb-150 breadcrumb__overlay" data-background="<?php echo base_url();?>assets_stunting/img/breadcrumb/breadcrumb-bg-1.jpg">
            <div class="container">
               <div class="row">
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                             <div class="course__thumb-2 w-img fix">
                                                <a href="course-details.html">
                                                   <img src="<?php echo base_url();?>assets_stunting/img/course/2/course-1.jpg" alt="">
                                                </a>
                                             </div>
                                             <div class="course__content-2">
                                                ...
                                                <div class="course__bottom-2 d-flex align-items-center justify-content-between">
                                                   ...
                                                   <div class="course__tutor-2">
                                                      <a href="#">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-1.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                             </div>
                                       ...
                                       <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                          <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                             <div class="course__thumb-2 w-img fix">
                                                <a href="course-details.html">
                                                   <img src="<?php echo base_url();?>assets_stunting/img/course/2/course-2.jpg" alt="">
                                                </a>
                                             </div>
                                             <div class="course__content-2">
                                                <div class="course__top-2 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="course__bottom-2 d-flex align-items-center justify-content-between">
                                                   ...
                                                   <div class="course__tutor-2">
                                                      <a href="#">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-2.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                             </div>
                                       ...
                                       <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                          <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                             <div class="course__thumb-2 w-img fix">
                                                <a href="course-details.html">
                                                   <img src="<?php echo base_url();?>assets_stunting/img/course/2/course-3.jpg" alt="">
                                                </a>
                                             </div>
                                             <div class="course__content-2">
                                                <div class="course__top-2 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="course__bottom-2 d-flex align-items-center justify-content-between">
                                                   ...
                                                   <div class="course__tutor-2">
                                                      <a href="#">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-3.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                             </div>
                                       ...
                                       <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                          <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                             <div class="course__thumb-2 w-img fix">
                                                <a href="course-details.html">
                                                   <img src="<?php echo base_url();?>assets_stunting/img/course/2/course-4.jpg" alt="">
                                                </a>
                                             </div>
                                             <div class="course__content-2">
                                                <div class="course__top-2 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="course__bottom-2 d-flex align-items-center justify-content-between">
                                                   ...
                                                   <div class="course__tutor-2">
                                                      <a href="#">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-4.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                             </div>
                                       ...
                                       <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                          <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                             <div class="course__thumb-2 w-img fix">
                                                <a href="course-details.html">
                                                   <img src="<?php echo base_url();?>assets_stunting/img/course/2/course-5.jpg" alt="">
                                                </a>
                                             </div>
                                             <div class="course__content-2">
                                                <div class="course__top-2 d-flex align-items-center justify-content-between">
                                                ...
                                                <h3 class="course__title-2">
                                                   <a href="course-details.html">Machine Learning A-Z: Hands-On Python and java.</a>
                                                </h3>
                                                <div class="course__bottom-2 d-flex align-items-center justify-content-between">
                                                   <div class="course__action">
                                                      <ul>
                                                   ...
                                                   <div class="course__tutor-2">
                                                      <a href="#">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-5.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                             </div>
                                       ...
                                       <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                                          <div class="course__item-2 transition-3 white-bg mb-30 fix">
                                             <div class="course__thumb-2 w-img fix">
                                                <a href="course-details.html">
                                                   <img src="<?php echo base_url();?>assets_stunting/img/course/2/course-6.jpg" alt="">
                                                </a>
                                             </div>
                                             <div class="course__content-2">
                                                <div class="course__top-2 d-flex align-items-center justify-content-between">
                                                ...
                                                <h3 class="course__title-2">
                                                   <a href="course-details.html">The most complete Design Thinking Course on the Market..</a>
                                                </h3>
                                                <div class="course__bottom-2 d-flex align-items-center justify-content-between">
                                                   <div class="course__action">
                                                      <ul>
                                                   ...
                                                   <div class="course__tutor-2">
                                                      <a href="#">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-6.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                             </div>
                                             ...
                                             <div class="row gx-0">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4">
                                                   <div class="course__thumb w-img p-relative fix">
                                                      <a href="course-details.html">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/list/course-1.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                                   ...
                                                   <div class="course__right p-relative">
                                                      <div class="course__content p-relative">
                                                         ...
                                                         <h3 class="course__title">
                                                            <a href="course-details.html">Non-Degree Seeking Online Design for Learning Environments.</a>
                                                         </h3>
                                                         ...
                                                         <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                                            <div class="course__tutor">
                                                               <a href="#"><img src="<?php echo base_url();?>assets_stunting/img/course/tutor/course-tutor-1.jpg" alt="">Brian Cumin</a>
                                                            </div>
                                          ...
                                          <div class="course__item course__item-list white-bg mb-30 fix transition-3">
                                             <div class="row gx-0">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4">
                                                   <div class="course__thumb w-img p-relative fix">
                                                      <a href="course-details.html">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/list/course-2.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8">
                                                   <div class="course__right p-relative">
                                                      <div class="course__content p-relative">
                                                         ...
                                                         <h3 class="course__title">
                                                            <a href="course-details.html">Language Assessment in the Classroom Course.</a>
                                                         </h3>
                                                         <div class="course__summary">
                                                            <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem.</p>
                                                         </div>
                                          ...
                                          <div class="course__item course__item-list white-bg mb-30 fix transition-3">
                                             <div class="row gx-0">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4">
                                                   <div class="course__thumb w-img p-relative fix">
                                                      <a href="course-details.html">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/list/course-3.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8">
                                                   <div class="course__right p-relative">
                                                      <div class="course__content p-relative">
                                                         ...
                                                         <h3 class="course__title">
                                                            <a href="course-details.html">A framework for keeping up with an ever-evolving profession.</a>
                                                         </h3>
                                                         <div class="course__summary">
                                                            <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem.</p>
                                                         </div>
                                          ...
                                          <div class="course__item course__item-list white-bg mb-30 fix transition-3">
                                             <div class="row gx-0">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4">
                                                   <div class="course__thumb w-img p-relative fix">
                                                      <a href="course-details.html">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/list/course-4.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8">
                                                   <div class="course__right p-relative">
                                                      <div class="course__content p-relative">
                                                         ...
                                                         <h3 class="course__title">
                                                            <a href="course-details.html">Expertise in a single subject or across a spectrum.</a>
                                                         </h3>
                                                         <div class="course__summary">
                                                            <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem.</p>
                                                         </div>
                                          ...
                                          <div class="course__item course__item-list white-bg mb-30 fix transition-3">
                                             <div class="row gx-0">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4">
                                                   <div class="course__thumb w-img p-relative fix">
                                                      <a href="course-details.html">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/list/course-5.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8">
                                                   <div class="course__right p-relative">
                                                      <div class="course__content p-relative">
                                                         ...
                                                         <h3 class="course__title">
                                                            <a href="course-details.html">Differentiation for Learning Course - National Learning Centre</a>
                                                         </h3>
                                                         <div class="course__summary">
                                                            <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem.</p>
                                                         </div>
                                          ...
                                          <div class="course__item course__item-list white-bg mb-30 fix transition-3">
                                             <div class="row gx-0">
                                                <div class="col-xxl-4 col-xl-4 col-lg-4">
                                                   <div class="course__thumb w-img p-relative fix">
                                                      <a href="course-details.html">
                                                         <img src="<?php echo base_url();?>assets_stunting/img/course/list/course-6.jpg" alt="">
                                                      </a>
                                                   </div>
                                                </div>
                                                <div class="col-xxl-8 col-xl-8 col-lg-8">
                                                   <div class="course__right p-relative">
                                                      <div class="course__content p-relative">
                                                         ...
                                                         <h3 class="course__title">
                                                            <a href="course-details.html">Teacher Development: Health Curriculum Course.</a>
                                                         </h3>
                                                         <div class="course__summary">
                                                            <p>Communia virtutes tutiorem declarat stoicorum sanabat oblivisci nostris tamquam iucunditatem</p>
                                                         </div>
         ...
         <footer>
            <div class="footer__area">
               <div class="footer__top footer__white white-bg pt-95 pb-45">
                  <div class="container">
                     <div class="row">
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-7">
                           <div class="footer__widget footer-col-1 mb-50">
                              <div class="footer__logo">
                                 <div class="logo">
                                    <a href="index.html">
                                       <img src="<?php echo base_url();?>assets_stunting/img/logo/logo.png" alt="">
                                    </a>
                                 </div>
                              </div>
               ...
               <div class="footer__bottom white-bg">
                  <div class="container">
