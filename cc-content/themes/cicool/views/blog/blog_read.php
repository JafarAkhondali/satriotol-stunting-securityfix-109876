                  ...
                  <div class="postbox__item transition-3 mb-70">
                     ...
                     <div class="postbox__content">
                        <div class="postbox__meta">
                           <span><i class="far fa-calendar-check"></i> Tanggal Upload </span>
                           <span><a href="#"><i class="far fa-user"></i> Yang Upload</a></span>
                           <span><a href="#"><i class="fal fa-eye"></i> 02 Pengunjung</a></span>
                        </div>
                        <h3 class="postbox__title">Judul Disini</h3>
               ...
               <div class="blog__sidebar pl-70">
                  ...
                  <div class="sidebar__widget mb-55">
                     <div class="sidebar__widget-head mb-35">
                        <h3 class="sidebar__widget-title">Berita Terkait ( Ngko Neng Kene dilimit 3, berita yang kategorine podo )</h3>
                     </div>
                     <div class="sidebar__widget-content">
