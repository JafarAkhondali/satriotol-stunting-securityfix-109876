...
<section class="content">
	<div class="row">
						...
						<div class="form-group ">
							...
							<div class="col-sm-9">
								<textarea id="content" name="content" rows="10"
									cols="80"> <?= set_value('content', $blog->content); ?></textarea>
					...
					<div class="form-group ">
						...
						<div class="col-sm-9">
							<select class="form-control chosen chosen-select" name="status" id="status"
								...
								<option value=""></option>
								<option <?= $blog->status == "publish" ? 'selected' :''; ?> value="publish">publish
								</option>
								<option <?= $blog->status == "draft" ? 'selected' :''; ?> value="draft">draft</option>
								<option <?= $blog->status == "archive" ? 'selected' :''; ?> value="archive">archive
								</option>
							</select>
						</div>
					</div>
		...
		<div class="col-md-4">
			<div class="box box box-solid box-blog-right">
				<div class="box-header">
					<h3>Category <i class="required">*</i></h3>
				</div>
				<div class="box-body ">
					<!-- Widget: user widget style 1 -->
					...
					<div class="form-group ">
						...
						<div class="col-sm-9">
							<select class="form-control chosen chosen-select-deselect" name="category" id="category"
								...
								<option <?=  $row->category_id ==  $blog->category ? 'selected' : ''; ?>
					...
					<div class="form-group ">
						<div class="col-sm-12">
							...
							<div id="blog_image_galery_listed">
								...
								<input type="hidden" class="listed_file_uuid" name="blog_image_uuid[<?= $idx ?>]"
									value="" /><input type="hidden" class="listed_file_name"
									name="blog_image_name[<?= $idx ?>]" value="<?= $filename; ?>" />
								<?php endforeach; ?>
							</div>
							<small class="info help-block">
