...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class=""><a href="<?= site_url('administrator/blog'); ?>">Berita</a></li>
		<li class="active">
			<?= cclang('new'); ?>
		</li>
	</ol>
				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="form-group ">
							<label for="title" class="col-sm-2 control-label">Judul berita
								<i class="required">*</i>
							</label>
							<div class="col-sm-9">
						...
						<div class="form-group ">
							<label for="content" class="col-sm-2 control-label">Deskripsi berita
								<i class="required">*</i>
							</label>
							<div class="col-sm-9">
								<textarea id="content" name="content" rows="8"
									cols="80"><?= set_value('Content'); ?></textarea>
								<small class="info help-block">
								</small>
							</div>
						</div>
