...
<section class="content-header">
	<h1>
		Sliders <small>Edit Sliders</small>
	</h1>
	<ol class="breadcrumb">
				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="widget-user-header ">
							...
							<h5 class="widget-user-desc">Edit Sliders</h5>
							<hr>
						</div>
						<?= 
					...
					?>
						...
						<div class="form-group group-slider-title  ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="slider_title" id="slider_title"
									...
									value="<?= set_value('slider_title', $sliders->slider_title); ?>">
								<small class="info help-block">
									<b>Input Slider Title</b> Max Length : 255.</small>
							</div>
						</div>
						...
						<div class="form-group group-slider-subtitle  ">
							...
							<div class="col-sm-8">
								<textarea id="slider_subtitle" name="slider_subtitle" rows="10"
									cols="80"> <?= set_value('slider_subtitle', $sliders->slider_subtitle); ?></textarea>
						...
						<div class="form-group group-slider-image  ">
							...
							<div class="col-sm-8">
								...
								<input class="data_file data_file_uuid" name="sliders_slider_image_uuid"
									id="sliders_slider_image_uuid" type="hidden"
									value="<?= set_value('sliders_slider_image_uuid'); ?>">
								<input class="data_file" name="sliders_slider_image_name" id="sliders_slider_image_name"
									type="hidden"
									value="<?= set_value('sliders_slider_image_name', $sliders->slider_image); ?>">
						...
						<!-- <div class="form-group ">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select" name="slider_status"
									...
									<option value=""></option>
									<option <?//=$sliders->slider_status == "0" ? 'selected' :''; ?> value="0">Tidak Aktif
									</option>
...
<script>
	$(document).ready(function () {
		...
		$('#sliders_slider_image_galery').fineUploader({
			...
			session: {
				endpoint: BASE_URL + 'administrator/sliders/get_slider_image_file/<?= $sliders->slider_id; ?>',
