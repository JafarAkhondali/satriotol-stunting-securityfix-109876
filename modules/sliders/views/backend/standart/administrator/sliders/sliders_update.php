                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group group-slider-subtitle  ">
                                <label for="slider_subtitle" class="col-sm-2 control-label">Deskripsi                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    <textarea id="slider_subtitle" name="slider_subtitle" rows="10" cols="80"> <?= set_value('slider_subtitle', $sliders->slider_subtitle); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                        ...
                        <div class="form-group ">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control chosen chosen-select" name="slider_status" id="slider_status" data-placeholder="Select Status">
                                        <option value=""></option>
                                        <option <?= $sliders->slider_status == "0" ? 'selected' :''; ?> value="0">Tidak Aktif</option>
