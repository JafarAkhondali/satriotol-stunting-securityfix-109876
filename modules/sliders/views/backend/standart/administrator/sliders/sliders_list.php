               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('sliders')]); ?>  (Ctrl+a)" href="<?=  site_url('administrator/sliders/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', [cclang('sliders')]); ?></a>
                        <?php }) ?>
                        <?php is_allowed('sliders_export', function(){?>
                        <a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> <?= cclang('sliders') ?> " href="<?= site_url('administrator/sliders/export?q='.$this->input->get('q').'&f='.$this->input->get('f')); ?>"><i class="fa fa-file-excel-o" ></i> <?= cclang('export'); ?> XLS</a>
                        <?php }) ?>
                                             </div>
                     ...
                     <!-- /.widget-user-image -->
                     <h3 class="widget-user-username"><?= cclang('sliders') ?></h3>
                     <h5 class="widget-user-desc"><?= cclang('list_all', [cclang('sliders')]); ?>  <i class="label bg-yellow"><?= $sliders_counts; ?>  <?= cclang('items'); ?></i></h5>
                  </div>
                     ...
                     <?php foreach($sliderss as $sliders): ?>
                        <tr>
                           ...
                           <td width="200">
                                                              ...
                                                              <a href="<?= site_url('administrator/sliders/view/' . $sliders->slider_id); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> <?= cclang('view_button'); ?>
                              <?php }) ?>
                              <?php is_allowed('sliders_update', function() use ($sliders){?>
                              <a href="<?= site_url('administrator/sliders/edit/' . $sliders->slider_id); ?>" class="label-default"><i class="fa fa-edit "></i> <?= cclang('update_button'); ?></a>
                              <?php }) ?>
                              <?php is_allowed('sliders_delete', function() use ($sliders){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/sliders/delete/' . $sliders->slider_id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> <?= cclang('remove_button'); ?></a>
                               <?php }) ?>
    ...
    $('#apply').click(function(){
      ...
      if (bulk.val() == 'delete') {
         swal({
          ...
          function(isConfirm){
            if (isConfirm) {
               document.location.href = BASE_URL + '/administrator/sliders/delete?' + serialize_bulk;      
            }
          });
