					...
					<div class="box box-widget widget-user-2">
						...
						<div class="widget-user-header ">
							...
							<h5 class="widget-user-desc">
								<?= cclang('list_all', [cclang('sliders')]); ?> <i class="label bg-yellow">
									<?= $sliders_counts; ?>
									<?= cclang('items'); ?>
								</i>
							</h5>
								...
								<div class="col-md-8">
									...
									<div class="col-sm-3 padd-left-0 ">
										<select type="text" class="form-control chosen chosen-select" name="f" id="field">
											...
											<option <?=$this->input->get('f') == 'slider_title' ? 'selected' :''; ?>
												value="slider_title">Judul</option>
											<option <?=$this->input->get('f') == 'slider_subtitle' ? 'selected' :''; ?>
												value="slider_subtitle">Deskripsi</option>
											<option <?=$this->input->get('f') == 'slider_image' ? 'selected' :''; ?>
												value="slider_image">Image</option>
											<option <?=$this->input->get('f') == 'slider_createAt' ? 'selected' :''; ?>
												value="slider_createAt">Tanggal Dibuat</option>
										</select>
									</div>
								...
								<table class="table table-bordered table-striped dataTable">
									<thead>
										<tr class="">
											...
											<th data-field="slider_subtitle" data-sort="1" data-primary-key="0">
												<?= cclang('slider_subtitle') ?>
											</th>
											<th data-field="slider_image" data-sort="0" data-primary-key="0">
												<?= cclang('slider_image') ?>
											</th>
											<th data-field="slider_createAt" data-sort="1" data-primary-key="0">
												<?= cclang('slider_createAt') ?>
											</th>
											<th>Action</th>
										</tr>
									</thead>
										...
										<tr>
											...
											<td>
												...
												<a class="fancybox" rel="group"
													href="<?= BASE_URL . 'uploads/sliders/' . $sliders->slider_image; ?>">
													<img src="<?= BASE_URL . 'uploads/sliders/' . $sliders->slider_image; ?>"
														class="image-responsive" alt="image sliders"
														title="slider_image sliders" width="40px">
												</a>
												<?php else: ?>
												<a href="<?= BASE_URL . 'uploads/sliders/' . $sliders->slider_image; ?>"
													target="blank">
													<img src="<?= get_icon_file($sliders->slider_image); ?>"
														class="image-responsive image-icon" alt="image sliders"
														title="slider_image <?= $sliders->slider_image; ?>"
														width="40px">
												</a>
												<?php endif; ?>
												<?php endif; ?>
