				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="form-group group-rencana-kegiatan-definisi ">
							...
							<div class="col-sm-8">
								<textarea id="rencana_kegiatan_definisi" name="rencana_kegiatan_definisi" rows="5"
									cols="80"><?= set_value('Rencana Kegiatan Definisi'); ?></textarea>
						...
						<div class="form-group group-rencana-kegiatan-tujuan ">
							...
							<div class="col-sm-8">
								<textarea id="rencana_kegiatan_tujuan" name="rencana_kegiatan_tujuan" rows="5"
									cols="80"><?= set_value('Rencana Kegiatan Tujuan'); ?></textarea>
								<small class="info help-block">
								</small>
							</div>
						</div>
						...
						<div class="form-group group-rencana-kegiatan-output ">
							...
							<div class="col-sm-8">
								<textarea id="rencana_kegiatan_output" name="rencana_kegiatan_output" rows="5"
									cols="80"><?= set_value('Rencana Kegiatan Output'); ?></textarea>
								<small class="info help-block">
								</small>
							</div>
						</div>
						...
						<div class="form-group group-rencana-kegiatan-meliputi ">
							...
							<div class="col-sm-8">
								<textarea id="rencana_kegiatan_meliputi" name="rencana_kegiatan_meliputi" rows="5"
									cols="80"><?= set_value('Rencana Kegiatan Meliputi'); ?></textarea>
								<small class="info help-block">
								</small>
							</div>
						</div>
						...
						<div class="form-group group-rencana-kegiatan-peran-opd ">
							...
							<div class="col-sm-8">
								<textarea id="rencana_kegiatan_peran_opd" name="rencana_kegiatan_peran_opd" rows="5"
									cols="80"><?= set_value('Rencana Kegiatan Peran Opd'); ?></textarea>
								<small class="info help-block">
								</small>
							</div>
						</div>
