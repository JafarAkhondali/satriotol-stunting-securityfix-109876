...
<section class="content-header">
    <h1>
        Rencana Kegiatan        <small><?= cclang('new', ['Rencana Kegiatan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Rencana Kegiatan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                                ...
                                <div class="col-sm-8">
                                    <textarea id="rencana_kegiatan_definisi" name="rencana_kegiatan_definisi" rows="5" cols="80"><?= set_value('Rencana Kegiatan Definisi'); ?></textarea>
                                ...
                                <div class="col-sm-8">
                                    <textarea id="rencana_kegiatan_tujuan" name="rencana_kegiatan_tujuan" rows="5" cols="80"><?= set_value('Rencana Kegiatan Tujuan'); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <textarea id="rencana_kegiatan_output" name="rencana_kegiatan_output" rows="5" cols="80"><?= set_value('Rencana Kegiatan Output'); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <textarea id="rencana_kegiatan_meliputi" name="rencana_kegiatan_meliputi" rows="5" cols="80"><?= set_value('Rencana Kegiatan Meliputi'); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <textarea id="rencana_kegiatan_peran_opd" name="rencana_kegiatan_peran_opd" rows="5" cols="80"><?= set_value('Rencana Kegiatan Peran Opd'); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
...
<script>
   ...
   var rencana_kegiatan_peran_opd = $('#rencana_kegiatan_peran_opd');
    ...
    $.ajax({
            url: BASE_URL + '/administrator/rencana_kegiatans/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
        .done(function(res) {
            ...
            rencana_kegiatan_definisi.setData('');
            
            rencana_kegiatan_tujuan.setData('');
            
            rencana_kegiatan_output.setData('');
            
            rencana_kegiatan_meliputi.setData('');
            
            rencana_kegiatan_peran_opd.setData('');
