                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        ?>
                                ...
                                <label for="rembuk_stunting_year" class="col-sm-2 control-label">Tahun                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    ...
                                    <small class="info help-block">
                                        <b>Input Rembuk Stunting Year</b> Max Length : 10.</small>
                                </div>
                            </div>
                        

                                                                                                                            <div class="form-group group-rembuk-stunting-file ">
                                <label for="rembuk_stunting_file" class="col-sm-2 control-label">File                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
...
<script>
    ...
    $.ajax({
        ...
        .done(function(res) {
            ...
            if (res.success) {
                var id_rembuk_stunting_file = $('#rembuk_stuntings_rembuk_stunting_file_galery').find('li').attr('qq-file-id');
            ...
            if(typeof id_rembuk_stunting_file !== 'undefined') {
                $('#rembuk_stuntings_rembuk_stunting_file_galery').fineUploader('deleteFile', id_rembuk_stunting_file);
            }
