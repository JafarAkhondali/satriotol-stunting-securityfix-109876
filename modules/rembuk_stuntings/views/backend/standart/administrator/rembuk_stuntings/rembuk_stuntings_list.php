								...
								<table class="table table-bordered table-striped dataTable">
									<thead>
										<tr class="">
											...
											<th data-field="rembuk_stunting_year" data-sort="1" data-primary-key="0">
												<?= cclang('rembuk_stunting_year') ?></th>
											<th data-field="rembuk_stunting_file" data-sort="0" data-primary-key="0">
												<?= cclang('rembuk_stunting_file') ?></th>
											<th>Action</th>
										</tr>
									</thead>
									<tbody id="tbody_rembuk_stuntings">
										...
										<tr>
											...
											<td><span
													class="list_group-rembuk-stunting-year"><?= _ent($rembuk_stuntings->rembuk_stunting_year); ?></span>
											</td>
											<td>
