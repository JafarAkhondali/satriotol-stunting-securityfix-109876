...
<section class="content-header">
    <h1>
        Tahun Lokus        <small><?= cclang('new', ['Tahun Lokus']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                        ...
                        ?>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <small class="info help-block">
                                        <b>Input Lokus Year Nama</b> Max Length : 255.</small>
                                </div>
                            </div>
                        

                                                                                                                            <div class="form-group group-lokus-year-file ">
                                <label for="lokus_year_file" class="col-sm-2 control-label">File Lokus                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    ...
                                    <small class="info help-block">
                                        <b>Extension file must</b> PDF.</small>
                                </div>
                            </div>
                        

                                                                                                                            <div class="form-group group-lokus-year-create-at ">
                                <label for="lokus_year_create_at" class="col-sm-2 control-label">Tahun Pembuatan                                    </label>
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datetimepicker" name="lokus_year_create_at" id="lokus_year_create_at">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
...
<script>
    ...
    $.ajax({
        ...
        .done(function(res) {
            ...
            if (res.success) {
                var id_lokus_year_file = $('#lokus_years_lokus_year_file_galery').find('li').attr('qq-file-id');
            ...
            if(typeof id_lokus_year_file !== 'undefined') {
                $('#lokus_years_lokus_year_file_galery').fineUploader('deleteFile', id_lokus_year_file);
            }
        ...
        $('#lokus_years_lokus_year_file_galery').fineUploader({
            ...
            callbacks: {
                onComplete: function(id, name, xhr) {
                    if (xhr.success) {
                        var uuid = $('#lokus_years_lokus_year_file_galery').fineUploader('getUuid', id);
