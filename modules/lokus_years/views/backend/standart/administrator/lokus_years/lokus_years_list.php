					...
					<div class="box box-widget widget-user-2">
						...
						<div class="widget-user-header ">
							<div class="row pull-right">
								...
								<a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('lokus_years')]); ?>  (Ctrl+a)" href="<?=  site_url('administrator/lokus_years/add'); ?>">
									<i class="fa fa-plus-square-o"></i>
									<?= cclang('add_new_button', [cclang('lokus_years')]); ?>
								</a>
								<?php }) ?>
								<?php is_allowed('lokus_years_export', function(){?>
								<a class="btn btn-flat btn-success" title="<?= cclang('export'); ?> <?= cclang('lokus_years');?>" href="<?= site_url('administrator/lokus_years/export?q='.$this->input->get('q').'&f='.$this->input->get('f')); ?>">
							...
							<h5 class="widget-user-desc"><?= cclang('list_all', [cclang('lokus_years')]); ?> <i
									class="label bg-yellow"><?= $lokus_years_counts; ?> <?= cclang('items'); ?></i></h5>
						</div>
						...
						<form name="form_lokus_years" id="form_lokus_years" action="<?= base_url('administrator/lokus_years/index'); ?>">
							...
							<div class="row">
								<div class="col-md-8">
									...
									<div class="col-sm-1 padd-left-0 ">
										<a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/lokus_years');?>"
		...
		$('#apply').click(function () {
			...
			if (bulk.val() == 'delete') {
				swal({
					...
					function (isConfirm) {
						if (isConfirm) {
							document.location.href = BASE_URL + '/administrator/lokus_years/delete?' +
								serialize_bulk;
						}
					});
