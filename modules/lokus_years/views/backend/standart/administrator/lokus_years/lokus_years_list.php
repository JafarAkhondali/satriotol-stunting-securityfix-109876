...
<section class="content-header">
	<h1><?= cclang('lokus_years') ?><small><?= cclang('list_all'); ?></small></h1>
	<ol class="breadcrumb">
		<li><a href="javascript:void(0);"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Tahun Lokus</li>
	</ol>
</section>
<!-- Main content -->
		...
		<div class="col-md-12">
			<div class="box box-danger">
				<div class="box-header">
					<h3 class="box-title">Data Tahun Lokus <i class="label bg-yellow"><?= $lokus_years_counts; ?> <?= cclang('items'); ?></i></h3>
