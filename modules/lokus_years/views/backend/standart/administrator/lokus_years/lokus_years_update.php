...
<section class="content-header">
	<h1>Tahun Lokus <small>Edit Tahun Lokus</small></h1>
	<ol class="breadcrumb">
		<li><a href="javascrpt:void(0);"><i class="fa fa-dashboard"></i> Home</a></li>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			...
			<?php
				echo form_open(base_url('administrator/lokus_years/edit_save/'.$this->uri->segment(4)), [
			...
			?>
				<div class="box-header">
					<h3 class="box-title">Update Tahun Lokus</h3>
				</div>
				<div class="box-body">
					<div class="form-group group-lokus-year-nama">
						<label for="lokus_year_nama" class="control-label">Tahun Lokus <i class="required">*</i></label>
					...
					<div class="form-group group-lokus-year-file">
						<label for="lokus_year_file" class="control-label">File Lokus <i class="required">*</i></label>
