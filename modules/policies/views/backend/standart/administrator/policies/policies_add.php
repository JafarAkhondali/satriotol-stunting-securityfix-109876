                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        ?>
                                ...
                                <label for="policies_file" class="col-sm-2 control-label">Upload File                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    <div id="policies_policies_file_galery"></div>
                                    <input class="data_file" name="policies_policies_file_uuid" id="policies_policies_file_uuid" type="hidden" value="<?= set_value('policies_policies_file_uuid'); ?>">
                                    <input class="data_file" name="policies_policies_file_name" id="policies_policies_file_name" type="hidden" value="<?= set_value('policies_policies_file_name'); ?>">
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
...
<script>
    ...
    $.ajax({
        ...
        .done(function(res) {
            ...
            if (res.success) {
                var id_policies_file = $('#policies_policies_file_galery').find('li').attr('qq-file-id');
            ...
            if(typeof id_policies_file !== 'undefined') {
                $('#policies_policies_file_galery').fineUploader('deleteFile', id_policies_file);
            }
