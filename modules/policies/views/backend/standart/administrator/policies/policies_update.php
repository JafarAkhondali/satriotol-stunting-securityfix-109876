                        ...
                        <div class="form-group group-policies-year">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control chosen chosen-select-deselect" name="policies_year" id="policies_year" data-placeholder="Select Tahun">
                                        <option value=""></option>
                                        <?php for ($i = 1970; $i < date('Y')+100; $i++){ ?> <option <?= $i==$policies->policies_year ? 'selected' : ''; ?> value="<?= $i; ?>"><?= $i; ?></option>
                                            <?php }; ?>
                                    </select>
                                    <small class="info help-block">
    ...
    */
    ...
    return false;
            ...
            $('#policies_policies_file_galery').fineUploader({
                ...
                session: {
                    endpoint: BASE_URL + 'administrator/policies/get_policies_file_file/<?= $policies->policies_id; ?>',
