...
<section class="content-header">
	<h1>
		<?= cclang('menu') ?>
		<small>
			<?= cclang('update_button', cclang('menu')) ?>
		</small>
	</h1>
	<ol class="breadcrumb">
                   ...
                   ?>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<select class="form-control chosen  chosen-select-deselect" name="parent" id="parent"
									...
									<option <?=$row->id == $menu->parent? 'selected="selected"' : ''; ?> value="
										<?= $row->id; ?>" >
										<?= ucwords($row->label); ?>
									</option>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<label class="col-md-2 padding-left-0">
									...
									class="flat-green menu_type" value="menu">
									<?= cclang('menu'); ?>
								</label>
								<label>
									<input <?=$menu->type == 'label' ? 'checked' : ''; ?> type="radio" name="type"
									class="flat-green menu_type" value="label">
									<?= cclang('label'); ?>
								</label>
								<small class="info help-block">
									Type Of Menu.
						...
						<div class="row-fluid col-md-7">
							...
							<a class="btn btn-flat btn-info btn_save btn_action btn_save_back" id="btn_save"
								data-stype='back' title="save and back to the list (Ctrl+d)"><i
									class="ion ion-ios-list-outline"></i>
								<?= cclang('save_and_go_the_list_button'); ?> List
							</a>
							<a class="btn btn-flat btn-default btn_action" id="btn_cancel" title="cancel (Ctrl+x)"><i
									class="fa fa-undo"></i>
								<?= cclang('cancel_button'); ?>
							</a>
							<span class="loading loading-hide"><img
									src="<?= BASE_ASSET; ?>/img/loading-spin-primary.svg"> <i>Loading, Saving
									data</i></span>
						</div>
						<?= form_close(); ?>
					</div>
