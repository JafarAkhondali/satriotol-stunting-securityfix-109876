			...
			<div class="box box-warning">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title pull-left">
						<?= cclang('menu') ?>
						<?= ucwords(str_replace('-', ' ', $this->uri->segment(4))); ?>
					</h3>
				</div>
				<div class="box-body ">
					<div class="message">
					...
					<div style="margin: 15px 0px 15px 0px !important;">
						...
						<a class="btn btn-flat btn-default btn_add_new" id="btn_add_new" title="add new menu (Ctrl+a)"
							href="<?= site_url('administrator/menu/add/'. $this->uri->segment(4)); ?>"><i
								class="fa fa-plus-square-o"></i>
							<?= cclang('add_new_button', cclang('menu')); ?>
						</a>
						<?php }) ?>
