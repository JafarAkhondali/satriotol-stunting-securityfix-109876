                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        ?>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input class="data_file" name="about_about_image_uuid" id="about_about_image_uuid" type="hidden" value="<?= set_value('about_about_image_uuid'); ?>">
                                    <input class="data_file" name="about_about_image_name" id="about_about_image_name" type="hidden" value="<?= set_value('about_about_image_name'); ?>">
                                    <small class="info help-block">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input class="data_file" name="about_about_logo_uuid" id="about_about_logo_uuid" type="hidden" value="<?= set_value('about_about_logo_uuid'); ?>">
                                    <input class="data_file" name="about_about_logo_name" id="about_about_logo_name" type="hidden" value="<?= set_value('about_about_logo_name'); ?>">
                                    <small class="info help-block">
                                        <b>Extension file must</b> JPG,JPEG,PNG.</small>
                                </div>
                            </div>
