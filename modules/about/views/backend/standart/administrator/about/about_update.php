   ...
   var about_address = $('#about_address');
    ...
    return false;
            ...
            $('#about_about_image_pengertian_galery').fineUploader({
                ...
                session: {
                    endpoint: BASE_URL + 'administrator/about/get_about_image_pengertian_file/<?= $about->about_id; ?>',
                    refreshOnRequest: true
                },
                multiple: false,
                validation: {
            ...
            $('#about_about_image_penyebab_galery').fineUploader({
                ...
                session: {
                    endpoint: BASE_URL + 'administrator/about/get_about_image_penyebab_file/<?= $about->about_id; ?>',
                    refreshOnRequest: true
                },
                multiple: false,
                validation: {
