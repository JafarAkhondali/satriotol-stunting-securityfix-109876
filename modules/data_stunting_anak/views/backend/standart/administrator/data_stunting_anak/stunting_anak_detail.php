						...
						<div class="col-md-6">
							<div class="table-responsive no-padding">
								<table class="table table-hover table-striped">
									<tr>
										<th>NIK Anak</th>
										<td><?= $data_stunting_anak->anak_nik != null ? $data_stunting_anak->anak_nik : '<i>belum ditentukan</i>';?></td>
									</tr>
									<tr>
										<th>Nama Anak</th>
										<td><?= $data_stunting_anak->anak_nama;?></td>
									</tr>
									<tr>
										<th>Tanggal Lahir Anak</th>
										<td><?= $data_stunting_anak->anak_tanggal_lahir;?></td>
									</tr>
									<tr>
										<th>Jenis Kelamin Anak</th>
										<td><?= $data_stunting_anak->anak_jenkel == '1' ? 'Laki-Laki' : 'Perempuan';?></td>
									</tr>
									<tr>
										<th>Alamat Rumah Anak</th>
										<td><?= $data_stunting_anak->anak_alamat;?></td>
									</tr>
									<tr>
										<th>RT / RW</th>
										<td><?= 'RT '.$data_stunting_anak->anak_rt.' / RW '.$data_stunting_anak->anak_rw;?></td>
									</tr>
									<tr>
										<th>Kecamatan, Kelurahan</th>
										<td><?= $data_stunting_anak->kelurahan_nama.' - '.$data_stunting_anak->kecamatan_nama;?></td>
									</tr>
								</table>
							</div>
						</div>
						<div class="col-md-6">
							<div class="table-responsive no-padding">
								<table class="table table-hover table-striped">
									<tr>
										<th>NIK Ayah</th>
										<td><?= $data_stunting_anak->anak_nik_ayah != null ? $data_stunting_anak->anak_nik_ayah : '<i>belum ditentukan</i>';?></td>
									</tr>
									<tr>
										<th>Nama Ayah</th>
										<td><?= $data_stunting_anak->anak_nama_ayah != null ? $data_stunting_anak->anak_nama_ayah : '<i>belum ditentukan</i>';?></td>
									</tr>
									<tr>
										<th>NIK Ibu</th>
										<td><?= $data_stunting_anak->anak_nik_ibu != null ? $data_stunting_anak->anak_nik_ibu : '<i>belum ditentukan</i>';?></td>
									</tr>
									<tr>
										<th>Nama Ibu</th>
										<td><?= $data_stunting_anak->anak_nama_ibu != null ? $data_stunting_anak->anak_nama_ibu : '<i>belum ditentukan</i>';?></td>
									</tr>
								</table>
							</div>
						</div>
			...
			<div class="box box-danger">
				...
				<div class="box-header">
					<div class="pull-right">
						<a class="btn btn-flat btn-primary btn-sm" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('data_stunting_anak')]); ?>  (Ctrl+a)" href="<?=  site_url('administrator/data_stunting_anak/add_stunting?anak='.$data_stunting_anak->anak_id); ?>">
				...
				<div class="box-body">
					...
					<?php
						$query_data_stunting = db_get_all_data('data_stunting_anak', ['stunting_anak_anak_id' => $data_stunting_anak->anak_id]);
