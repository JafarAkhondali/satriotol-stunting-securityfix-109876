                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        ?>
                                ...
                                <label for="lokus_year_id" class="col-sm-2 control-label">Tahun Lokus                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                ...
                                <label for="kelurahan_id" class="col-sm-2 control-label">Nama Kelurahan                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    ...
                                    <small class="info help-block">
                                                                                                                            ...
                                                                                                                            <div class="form-group group-lokus-stunting-create-at ">
                                <label for="lokus_stunting_create_at" class="col-sm-2 control-label">Tanggal Pembuatan                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datetimepicker" name="lokus_stunting_create_at" id="lokus_stunting_create_at">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
