...
class Model_kelurahans extends MY_Model {
    ...
    public function join_avaiable() {
        ...
        $this->db->select('kecamatans.kecamatan_nama,kelurahans.*,kecamatans.kecamatan_nama as kecamatans_kecamatan_nama,kecamatans.kecamatan_nama as kecamatan_nama');
