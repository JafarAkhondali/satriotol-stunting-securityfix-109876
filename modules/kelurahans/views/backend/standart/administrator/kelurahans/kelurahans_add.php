                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        ?>
                                ...
                                <label for="kecamatan_id" class="col-sm-2 control-label">Nama Kecamatan                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                ...
                                <label for="kelurahan_nama" class="col-sm-2 control-label">Nama Kelurahan                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    ...
                                    <small class="info help-block">
                                        <b>Input Kelurahan Nama</b> Max Length : 255.</small>
                                </div>
                            </div>
                        

                                                                                                                            <div class="form-group group-kelurahan-create-at ">
                                <label for="kelurahan_create_at" class="col-sm-2 control-label">Tanggal Pembuatan                                    </label>
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datetimepicker" name="kelurahan_create_at" id="kelurahan_create_at">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
                                                                                                                            ...
                                                                                                                            <div class="form-group group-kelurahan-create-user ">
                                <label for="kelurahan_create_user" class="col-sm-2 control-label">Pembuatan                                    </label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="kelurahan_create_user" id="kelurahan_create_user" placeholder="Pembuatan" value="<?= set_value('kelurahan_create_user'); ?>">
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
