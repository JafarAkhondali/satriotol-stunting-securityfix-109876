						...
						<div class="widget-user-header ">
							<div class="row pull-right">
								...
								<a class="btn btn-flat btn-success btn_add_new" id="btn_add_new"
									title="add new permission (Ctrl+a)"
									href="<?= site_url('administrator/permission/add'); ?>"><i
										class="fa fa-plus-square-o"></i>
									<?= cclang('add_new_button', 'Permission'); ?>
								</a>
								<?php }) ?>
							</div>
					...
					<div class="row-fluid">
						...
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								...
								<li class="<?= $i++ == 1 ? 'active' :''; ?>"><a href="#tab_<?= $i; ?>" class="tab_group"
										data-toggle="tab" data-id="<?= $group->id; ?>">
										<?= _ent($group->name); ?>
									</a></li>
								<?php endforeach; ?>
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li role="presentation"><a role="menuitem" tabindex="-1"
												href="<?= site_url('administrator/group/add'); ?>">
												<?= cclang('add_new_button', 'Group'); ?>
											</a></li>
										<?php endif; ?>
										<?php if ($this->aauth->is_allowed('group_list')): ?>
										<li role="presentation"><a role="menuitem" tabindex="-1"
												href="<?= site_url('administrator/group'); ?>">
												<?= cclang('view_all_button', 'Group'); ?>
											</a></li>
										<?php endif; ?>
									</ul>
								</li>
								<li class="pull-right"><a href="<?= site_url('administrator/permission'); ?>"
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
									<label><input type="checkbox" class="flat-red toltip" id="check_all"
										...
										<?= cclang('check_all'); ?>
									</label> <input type="text" id="search" name="search"
										placeholder="<?= cclang('filter'); ?> access">
                              ...
                              'method'  => 'POST'
									...
									<input type="hidden" name="group_id" id="group_id"
										value="<?= isset($groups[0]->id) ? $groups[0]->id : 0; ?>">
						...
						<a class="btn btn-flat btn-default btn_undo" data-id="0" id="btn_undo" title="undo (Ctrl+x)"
							style="display: none;"><i class="fa fa-undo"></i>
							<?= cclang('undo_button'); ?>
						</a>
						<?= form_close(); ?>
					</div>
