    				...
    				<div class="box-body ">
                        ...
                        ?>
    						<div class="form-group group-analisa-situasi-id ">
    							<label for="analisa_situasi_id" class="col-sm-2 control-label">Reff Analisa Situasi <i
    									class="required">*</i>
    							</label>
    							<div class="col-sm-8">
    								<select class="form-control chosen chosen-select-deselect" name="analisa_situasi_id"
    									id="analisa_situasi_id" data-placeholder="Select Reff Analisa Situasi">
    									<option value=""></option>
    								</select>
    						...
    						<div class="form-group group-analisa-situasi-aksi-indikator ">
    							<label for="analisa_situasi_aksi_indikator" class="col-sm-2 control-label">Indikator <i
    									class="required">*</i>
    							</label>
    							<div class="col-sm-8">
    								<input type="text" class="form-control" name="analisa_situasi_aksi_indikator"
    									id="analisa_situasi_aksi_indikator" placeholder="Indikator"
    									value="<?= set_value('analisa_situasi_aksi_indikator'); ?>">
    								<small class="info help-block">
    						...
    						<div class="form-group group-analisa_situasi_aksi_cakupan ">
    							<label for="analisa_situasi_aksi_cakupan" class="col-sm-2 control-label">Cakupan <i
    									class="required">*</i>
    							</label>
    							<div class="col-sm-8">
    								<input type="text" class="form-control" name="analisa_situasi_aksi_cakupan"
    									id="analisa_situasi_aksi_cakupan" placeholder="Cakupan"
