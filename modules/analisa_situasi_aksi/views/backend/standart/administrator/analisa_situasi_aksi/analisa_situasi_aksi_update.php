			...
			<div class="box box-warning">
				...
				?>
						...
						<div class="form-group group-analisa-situasi-aksi-indikator  ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="analisa_situasi_aksi_indikator" id="analisa_situasi_aksi_indikator" placeholder=""
									value="<?= set_value('analisa_situasi_aksi_indikator', $analisa_situasi_aksi->analisa_situasi_aksi_indikator); ?>">
						...
						<div class="form-group group-analisa_situasi_aksi_cakupan  ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="analisa_situasi_aksi_cakupan" id="analisa_situasi_aksi_cakupan" placeholder=""
									value="<?= set_value('analisa_situasi_aksi_cakupan', $analisa_situasi_aksi->analisa_situasi_aksi_cakupan); ?>">
						...
						<div class="form-group group-analisa_situasi_aksi_warna">
							...
							<div class="col-sm-8">
								<input type="hidden" class="form-control" name="analisa_situasi_aksi_warna" id="analisa_situasi_aksi_warna" placeholder="Warna"
									value="<?= set_value('analisa_situasi_aksi_warna', $analisa_situasi_aksi->analisa_situasi_aksi_warna); ?>">
