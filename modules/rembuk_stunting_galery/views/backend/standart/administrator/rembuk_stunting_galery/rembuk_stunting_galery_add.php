    ...
    <section class="content-header">
    	...
    	<ol class="breadcrumb">
    		...
    		<li class=""><a href="<?= site_url('administrator/rembuk_stunting_galery'); ?>">Rembuk Stunting Galery</a>
    		</li>
    				...
    				<div class="box-body ">
                        ...
                        ?>
    						<div class="form-group group-rembuk_stunting_id ">
    							<label for="rembuk_stunting_id" class="col-sm-2 control-label">Reff Rembuk Stunting <i class="required">*</i></label>
    							<div class="col-sm-8">
    						...
    						<div class="form-group group-rembuk_stunting_galery_image ">
    							<label for="rembuk_stunting_galery_image" class="col-sm-2 control-label">Gambar <i class="required">*</i></label>
    							<div class="col-sm-8">
    								<div id="rembuk_stunting_galery_rembuk_stunting_galery_image_galery"></div>
    								<div id="rembuk_stunting_galery_rembuk_stunting_galery_image_galery_listed"></div>
    ...
    <script>
    	$(document).ready(function () {
    			...
    			callbacks: {
    				onComplete: function (id, name, xhr) {
    					if (xhr.success) {
    						...
    						$('#rembuk_stunting_galery_rembuk_stunting_galery_image_galery_listed')
    							.append(
			...
			function chained_rembuk_stunting_id(selected, complete) {
				...
				return $.ajax({
					url: BASE_URL + '/administrator/rembuk_stunting_galery/ajax_rembuk_stunting_id/',
					dataType: 'JSON',
				})
				.done(function(res) {
    		...
    		// 	$.ajax({
			// 		url: BASE_URL +
			// 			'/administrator/rembuk_stunting_galery/ajax_rembuk_stunting_id/' + val,
			// 		dataType: 'JSON',
			// 	})
			// 	.done(function (res) {
			// 		var html = '<option value=""></option>';
			// 		$.each(res, function (index, val) {
			// 			html += '<option value="' + val.rembuk_stunting_id + '">' + val
			// 				.rembuk_stunting_year + '</option>'
			// 		});
			// 		$('#rembuk_stunting_id').html(html);
			// 		$('#rembuk_stunting_id').trigger('chosen:updated');
