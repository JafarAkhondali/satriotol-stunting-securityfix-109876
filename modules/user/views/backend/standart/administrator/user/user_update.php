...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class=""><a href="<?= site_url('administrator/user'); ?>">
				<?= cclang('user'); ?>
			</a></li>
		<li class="active">
			<?= cclang('update'); ?>
                    ...
                    'method'  => 'POST'
						...
						<div class="form-group ">
							<label for="username" class="col-sm-2 control-label">
								<?= cclang('username'); ?> <i class="required">*</i>
							</label>
						...
						<div class="form-group ">
							<label for="email" class="col-sm-2 control-label">
								<?= cclang('email'); ?> <i class="required">*</i>
							</label>
						...
						<div class="form-group ">
							<label for="full_name" class="col-sm-2 control-label">
								<?= cclang('full_name'); ?> <i class="required">*</i>
							</label>

							<div class="col-sm-8">
								<input type="text" class="form-control" name="full_name" id="full_name"
									placeholder="Full Name" value="<?= set_value('full_name', $user->full_name); ?>">
								<small class="info help-block">The full name of user.</small>
							</div>
						</div>
						<div class="form-group ">
							<label for="content" class="col-sm-2 control-label">
								<?= cclang('groups'); ?> <i class="required">*</i>
							</label>
							...
							<?php
								...
								foreach ($data as $row):
							?>
									<option <?=array_search($row->id, $group_user) !== false? 'selected="selected"' : ''; ?> value="
										<?= $row->id; ?>" >
										<?= ucwords($row->name); ?>
									</option>
									<?php endforeach; ?>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<div id="user_avatar_galery" src="<?= BASE_URL . 'uploads/user/' . $user->avatar; ?>">
								</div>
								<input name="user_avatar_uuid" id="user_avatar_uuid" type="hidden"
									value="<?= set_value('user_avatar_uuid'); ?>">
								<input name="user_avatar_name" id="user_avatar_name" type="hidden"
									value="<?= set_value('user_avatar_name', $user->avatar); ?>">
								<small class="info help-block">
						...
						<div class="form-group ">
							...
							<div class="col-sm-6">
								...
								<small class="info help-block">
									<?= cclang('do_not_be_fill_if_you_do_not_want_to_change_the_password'); ?>, <br>The
									password character must 6 or more.
								</small>
							</div>
						</div>
						<?php }) ?>
