                    ...
                    'method'  => 'POST'
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="full_name" id="full_name"
									placeholder="Full Name" value="<?= set_value('full_name'); ?>">
						...
						<div class="form-group ">
							<label for="password" class="col-sm-2 control-label">
								<?= cclang('password') ?> <i class="required">*</i>
							</label>
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								<select class="form-control chosen chosen-select" name="group[]" id="group"
									tabi-ndex="5" multiple placeholder="Select groups">
							<?php
						...
						<div class="form-group ">
							...
							<div class="col-sm-8">
								...
								<input name="user_avatar_name" id="user_avatar_name" type="hidden"
									value="<?= set_value('user_avatar_name'); ?>">
								<small class="info help-block">
