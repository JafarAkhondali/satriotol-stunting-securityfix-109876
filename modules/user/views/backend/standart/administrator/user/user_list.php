						...
						<div class="widget-user-header ">
							<div class="row pull-right">
								...
								<a class="btn btn-flat btn-success btn_add_new" id="btn_add_new"
									title="<?= cclang('add_new_button', cclang('user')); ?> (Ctrl+a)"
									href="<?= site_url('administrator/user/add'); ?>"><i
										class="fa fa-plus-square-o"></i>
									<?= cclang('add_new_button', cclang('user')); ?>
								</a>
								<?php }) ?>
								<?php is_allowed('user_export', function(){?>
								<a class="btn btn-flat btn-success"
									title="<?= cclang('export', 'Excel '.cclang('user')); ?>"
									href="<?= site_url('administrator/user/export'); ?>"><i
										class="fa fa-file-excel-o"></i>
									<?= cclang('export', 'Excel '.cclang('user')); ?>
								</a>
								<?php }) ?>
								<?php is_allowed('user_export', function(){?>
								<a class="btn btn-flat btn-success" title="<?= cclang('export', 'PDF User'); ?>"
									href="<?= site_url('administrator/user/export_pdf'); ?>"><i
							...
							<h5 class="widget-user-desc">
								<?= cclang('list_all', cclang('user')); ?> <i class="label bg-yellow">
									<?= $user_counts; ?>
									<?= cclang('items'); ?>
								</i>
							</h5>
								...
								<table class="table table-bordered table-striped dataTable">
									<thead>
										<tr class="">
											...
											<th data-field="full_name" data-sort="1">
												<?= cclang('user') ?>
											</th>
											<th data-field="username" data-sort="1">
												<?= cclang('username') ?>
											</th>
											<th data-field="status" data-sort="1">
												<?= cclang('status') ?>
											</th>
											<th>
												<?= cclang('action') ?>
									...
									<tbody id="tbody_user">
										...
										<tr>
											...
											<td>
												...
												<input type="checkbox" name="status" data-user-id="<?= $user->id; ?>"
													class="switch-button" <?=$user->banned ?:'checked'; ?> >
											</td>
											<td width="200">
						...
						<div class="col-md-8">
							...
							<div class="col-sm-2 padd-left-0 ">
								<button type="button" class="btn btn-flat" name="apply" id="apply" value="Apply"
									title="<?= cclang('apply_bulk_action', 'User'); ?>">
									<?= cclang('apply_button', 'User'); ?>
								</button>
							</div>
							...
							<div class="col-sm-3 padd-left-0 ">
								<select type="text" class="form-control chosen chosen-select" name="f" id="field">
									...
									<option <?=$this->input->get('f') == 'email' ? 'selected' :''; ?>
