...
<script type="text/javascript">
	...
	function domo() {
		...
		$('*').bind('keydown', 'Ctrl+a', function assets() {
			window.location.href = BASE_URL + '/administrator/Data_stunting/add';
			return false;
		});
						...
						<div class="widget-user-header">
							<div class="row pull-right">
								...
								<a class="btn btn-flat btn-success btn_add_new" id="btn_add_new"
									title="<?= cclang('add_new_button', [cclang('data_stunting')]); ?>  (Ctrl+a)"
									href="<?=  site_url('administrator/data_stunting/add'); ?>"><i
								...
								<a class="btn btn-flat btn-success"
									title="<?= cclang('export'); ?> <?= cclang('data_stunting') ?> "
									href="<?= site_url('administrator/data_stunting/export?q='.$this->input->get('q').'&f='.$this->input->get('f')); ?>"><i
								...
								<div class="col-md-8">
									...
									<div class="col-sm-3 padd-left-0">
										<select type="text" class="form-control chosen chosen-select" name="f"
											...
											<option <?= $this->input->get('f') == 'puskesmas' ? 'selected' :''; ?>
												value="puskesmas">Puskesmas</option>
											<option <?= $this->input->get('f') == 'kecamatan' ? 'selected' :''; ?>
												value="kecamatan">Kecamatan</option>
											<option <?= $this->input->get('f') == 'kelurahan' ? 'selected' :''; ?>
												value="kelurahan">Kelurahan</option>
											<option <?= $this->input->get('f') == 'no_kk' ? 'selected' :''; ?>
												value="no_kk">No. KK</option>
											<option <?= $this->input->get('f') == 'nik_anak' ? 'selected' :''; ?>
												value="nik_anak">NIK Anak</option>
											<option <?= $this->input->get('f') == 'nama_anak' ? 'selected' :''; ?>
												value="nama_anak">Nama Anak</option>
											<option <?= $this->input->get('f') == 'jenis_kel' ? 'selected' :''; ?>
												value="jenis_kel">Jenis Kelamin</option>
											<option <?= $this->input->get('f') == 'tanggal_lahir' ? 'selected' :''; ?>
												value="tanggal_lahir">Tanggal Lahir</option>
										</select>
									</div>
