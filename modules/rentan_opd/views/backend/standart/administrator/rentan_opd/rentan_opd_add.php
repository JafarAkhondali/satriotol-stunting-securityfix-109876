...
<section class="content-header">
    <h1>
        Rencana Kegiatan OPD        <small><?= cclang('new', ['Rencana Kegiatan OPD']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Rencana Kegiatan OPD']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                                ...
                                <label for="opd_id" class="col-sm-2 control-label">Dinas / OPD / Instansi                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                ...
                                <label for="rentan_opd_kegiatan" class="col-sm-2 control-label">Rencana Kegiatan                                    <i class="required">*</i>
                                    </label>
                                <div class="col-sm-8">
                                    ...
                                    <small class="info help-block">
                                                                                                                            ...
                                                                                                                            <div class="form-group group-rentan-opd-create-at ">
                                <label for="rentan_opd_create_at" class="col-sm-2 control-label">Create At                                    </label>
                                <div class="col-sm-6">
                                    <div class="input-group date col-sm-8">
                                        <input type="text" class="form-control pull-right datetimepicker" name="rentan_opd_create_at" id="rentan_opd_create_at">
                                    </div>
                                    <small class="info help-block">
                                        </small>
                                </div>
...
<script>
    ...
    $.ajax({
            url: BASE_URL + '/administrator/rentan_opd/add_save',
            type: 'POST',
            dataType: 'json',
            data: data_post,
        })
