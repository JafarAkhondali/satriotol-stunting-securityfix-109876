                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group group-rentan-opd-kegiatan  ">
                                ...
                                <div class="col-sm-8">
                                    <textarea placeholder="Rencana Kegiatan" id="rentan_opd_kegiatan" name="rentan_opd_kegiatan" rows="5" class="textarea form-control"><?= set_value('rentan_opd_kegiatan', $rentan_opd->rentan_opd_kegiatan); ?></textarea>
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
        ...
        return $.ajax({
            ...
            .done(function(res) {
                ...
                $.each(res, function(index, val) {
                    html += '<option ' + (selected == val.opd_id ? 'selected' : '') + ' value="' + val.opd_id + '">' + val.opd_nama + '</option>'
                });
                $('#opd_id').html(html);
