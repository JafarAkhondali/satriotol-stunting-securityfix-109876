...
<section class="content-header">
	<h1>Galeri Rencana Kegiatan OPD <small>Edit Galeri Rencana Kegiatan OPD</small></h1>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			...
			<?php 
				echo form_open(base_url('administrator/rentan_opd_galeri/edit_save/'.$this->uri->segment(4)), [
			...
			?>
				<div class="box-header">
					<h3 class="box-title">Update Data Galeri Rencana Kegiatan Dinas</h3>
				</div>
				<div class="box-body">
					<div class="form-group group-rentan-opd-id">
						<label for="rentan_opd_id" class="control-label">Kegiatan <i class="required">*</i></label>
						<select class="form-control chosen chosen-select-deselect" name="rentan_opd_id"
							id="rentan_opd_id" data-placeholder="Select Kegiatan">
							<option value=""></option>
						</select>
					...
					<div class="form-group group-rentan-opd-galeri-file">
						...
						<div id="rentan_opd_galeri_rentan_opd_galeri_file_galery_listed">
							...
							<input type="hidden" class="listed_file_uuid"
								name="rentan_opd_galeri_rentan_opd_galeri_file_uuid[<?= $idx ?>]"
								value="" /><input type="hidden" class="listed_file_name"
								name="rentan_opd_galeri_rentan_opd_galeri_file_name[<?= $idx ?>]"
								value="<?= $filename; ?>" />
							<?php endforeach; ?>
						</div>
...
<script>
	$(document).ready(function () {
		...
		$('#rentan_opd_galeri_rentan_opd_galeri_file_galery').fineUploader({
			...
			session: {
				endpoint: BASE_URL +
					'administrator/rentan_opd_galeri/get_rentan_opd_galeri_file_file/<?= $rentan_opd_galeri->rentan_opd_galeri_id; ?>',
