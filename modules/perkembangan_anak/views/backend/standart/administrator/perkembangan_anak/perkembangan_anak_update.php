            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/perkembangan_anak/edit_save/'.$this->uri->segment(4)), [
                        ...
                        <div class="form-group group-perkembangan_anak_id">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control chosen chosen-select-deselect" name="perkembangan_anak_id" id="perkembangan_anak_id" data-placeholder="Select Nama Anak">
                                        ...
                                        <option <?= $row->anak_id == $perkembangan_anak->perkembangan_anak_id ? 'selected' : ''; ?> value="<?= $row->anak_id ?>"><?= $row->anak_nama; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                        ...
                        <div class="form-group group-perkembangan_foto  ">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div id="perkembangan_anak_perkembangan_foto_galery_listed">
                                        ...
                                        <input type="hidden" class="listed_file_uuid" name="perkembangan_anak_perkembangan_foto_uuid[<?= $idx ?>]" value="" /><input type="hidden" class="listed_file_name" name="perkembangan_anak_perkembangan_foto_name[<?= $idx ?>]" value="<?= $filename; ?>" />
                                        <?php endforeach; ?>
                                    </div>
                                    <small class="info help-block">
                        ...
                        <div class="form-group group-perkembangan_keterangan  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="perkembangan_keterangan" id="perkembangan_keterangan" placeholder="" value="<?= set_value('perkembangan_keterangan', $perkembangan_anak->perkembangan_keterangan); ?>">
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
   ...
   var perkembangan_keterangan = $('#perkembangan_keterangan');
    ...
    return false;
        ...
        $('#perkembangan_anak_perkembangan_foto_galery').fineUploader({
            ...
            session: {
                endpoint: BASE_URL + 'administrator/perkembangan_anak/get_perkembangan_foto_file/<?= $perkembangan_anak->perkembangan_id; ?>',
