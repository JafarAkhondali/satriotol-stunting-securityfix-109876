                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        ?>
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="analisa_situasi_year" id="analisa_situasi_year" placeholder="Tahun" value="<?= set_value('analisa_situasi_year'); ?>">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input class="data_file" name="analisa_situasi_analisa_situasi_image_uuid" id="analisa_situasi_analisa_situasi_image_uuid" type="hidden" value="<?= set_value('analisa_situasi_analisa_situasi_image_uuid'); ?>">
                                    <input class="data_file" name="analisa_situasi_analisa_situasi_image_name" id="analisa_situasi_analisa_situasi_image_name" type="hidden" value="<?= set_value('analisa_situasi_analisa_situasi_image_name'); ?>">
                                    <small class="info help-block">
                                        </small>
                                </div>
                            </div>
...
<script>
    ...
    $.ajax({
        ...
        .done(function(res) {
            ...
            if (res.success) {
                var id_analisa_situasi_image = $('#analisa_situasi_analisa_situasi_image_galery').find('li').attr('qq-file-id');
            ...
            if(typeof id_analisa_situasi_image !== 'undefined') {
                $('#analisa_situasi_analisa_situasi_image_galery').fineUploader('deleteFile', id_analisa_situasi_image);
            }
