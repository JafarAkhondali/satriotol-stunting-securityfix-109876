					...
					<div class="box box-widget widget-user-2">
						...
						<div class="form-group group-analisa-situasi-year  ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="analisa_situasi_year"
									id="analisa_situasi_year" placeholder=""
									value="<?= set_value('analisa_situasi_year', $analisa_situasi->analisa_situasi_year); ?>">
						...
						<div class="form-group group-analisa-situasi-image  ">
							...
							<div class="col-sm-8">
								...
								<input class="data_file data_file_uuid"
									name="analisa_situasi_analisa_situasi_image_uuid"
								...
								<input class="data_file" name="analisa_situasi_analisa_situasi_image_name"
									...
									value="<?= set_value('analisa_situasi_analisa_situasi_image_name', $analisa_situasi->analisa_situasi_image); ?>">
								<small class="info help-block">
...
<script>
	...
	*/
		...
		$('#analisa_situasi_analisa_situasi_image_galery').fineUploader({
			...
			session: {
				endpoint: BASE_URL +
					'administrator/analisa_situasi/get_analisa_situasi_image_file/<?= $analisa_situasi->analisa_situasi_id; ?>',
